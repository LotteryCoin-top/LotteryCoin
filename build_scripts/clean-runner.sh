...
rm -rf ../venv || true
rm -rf venv || true
rm -rf lottery_blockchain.egg-info || true
rm -rf build_scripts/final_installer || true
rm -rf build_scripts/dist || true
rm -rf build_scripts/pyinstaller || true
rm -rf LotteryCoin-gui/build || true
rm -rf LotteryCoin-gui/daemon || true
rm -rf LotteryCoin-gui/node_modules || true
rm LotteryCoin-gui/temp.json || true
(cd "$PWD/LotteryCoin-gui" && git checkout HEAD -- package-lock.json) || true
cd "$PWD" || true
