...
dependencies = [
    ...
    "anyio==4.3.0",
    "boto3==1.34.148",  # AWS S3 for DL s3 plugin
...
kwargs = dict(
    name="LotteryCoin",
    author="lottery",
    author_email="service@lotterycoin.top",
    description="LotteryCoin full node, farmer, timelord, and wallet.",
    url="https://lotterycoin.top/",
    license="Apache License",
    python_requires=">=3.8.1, <4",
    keywords="LotteryCoin node",
    ...
    entry_points={
        "console_scripts": [
            "lottery = chia.cmds.lottery:main",
            "lottery_daemon = chia.daemon.server:main",
            "lottery_wallet = chia.server.start_wallet:main",
            "lottery_full_node = chia.server.start_full_node:main",
            "lottery_harvester = chia.server.start_harvester:main",
            "lottery_farmer = chia.server.start_farmer:main",
            "lottery_introducer = chia.server.start_introducer:main",
            "lottery_crawler = chia.seeder.start_crawler:main",
            "lottery_seeder = chia.seeder.dns_server:main",
            "lottery_timelord = chia.server.start_timelord:main",
            "lottery_timelord_launcher = chia.timelord.timelord_launcher:main",
            "lottery_full_node_simulator = chia.simulator.start_simulator:main",
            "lottery_data_layer = chia.server.start_data_layer:main",
            "lottery_data_layer_http = chia.data_layer.data_layer_server:main",
            "lottery_data_layer_s3_plugin = chia.data_layer.s3_plugin_service:run_server",
        ]
    },
    package_data={
