...
"""
run_block: Convert an encoded FullBlock from the LotteryCoin into a list of transactions
...
$ca_root is the directory containing your current Lottery config files
