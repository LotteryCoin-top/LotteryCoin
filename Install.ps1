...
{
    Write-Output "LotteryCoin requires a 64-bit Windows installation"
    Exit 1
}
...
Write-Output ""
Write-Output "LotteryCoin .\Install.ps1 complete."
Write-Output "For assistance join us on Discord in the #support chat channel:"
Write-Output "https://discord.com/invite/pTMp9R4v2w"
Write-Output ""
Write-Output "To install the GUI run '.\venv\scripts\Activate.ps1' then '.\Install-gui.ps1'."
Write-Output ""
Write-Output "Type '.\venv\Scripts\Activate.ps1' and then 'lottery init' to begin."