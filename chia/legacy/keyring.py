"""
Provides a helper to access the legacy keyring which was supported up to version 1.6.1 of LotteryCoin. To use this
...
DEFAULT_USER = f"user-lottery-{CURRENT_KEY_VERSION}"  # e.g. user-lottery-1.8
DEFAULT_SERVICE = f"lottery-{DEFAULT_USER}"  # e.g. lottery-user-lottery-1.8
MAX_KEYS = 100
