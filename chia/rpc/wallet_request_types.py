...
@streamable
@dataclass(frozen=True)
class RecoverPoolNFTResponse(TransactionEndpointResponse):
    transaction: TransactionRecord
    transaction_id: bytes32
    num: uint32
    amount: uint64
...
@streamable
@dataclass(frozen=True)
class SendStakeResponse(TransactionEndpointResponse):
    transaction: TransactionRecord
    transaction_id: bytes32
...
@streamable
@dataclass(frozen=True)
class SendGuessResponse(TransactionEndpointResponse):
    transaction: TransactionRecord
    transaction_id: bytes32
