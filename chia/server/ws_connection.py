...
ConnectionCallback = Callable[["WSLotteryConnection"], Awaitable[None]]
...
class ConnectionClosedCallbackProtocol(Protocol):
    async def __call__(
        self,
        connection: WSLotteryConnection,
        ban_time: int,
