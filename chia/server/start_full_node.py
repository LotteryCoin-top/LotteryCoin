...
def main() -> int:
    ...
    with maybe_manage_task_instrumentation(enable=os.environ.get("LOTTERY_INSTRUMENT_NODE") is not None):
        ...
        if not service_config.get("use_lottery_loop_policy", True):
            target_peer_count = None
