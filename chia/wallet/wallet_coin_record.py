...
from chia.wallet.puzzles.stake.metadata import StakeVersion, StakeMetadata
    ...
    def to_json_dict_parsed_metadata(self) -> Dict[str, Any]:
        ...
        if self.metadata is not None:
            if self.coin_type == CoinType.STAKE:
                ...
                metadata_dict["time_lock"] = metadata.time_lock
            else:
                metadata_dict = self.parsed_metadata().to_json_dict()
        return {
