    ...
    try:
        if supports_os_passphrase_storage():
            ...
            print(
                ...
                "Other Lottery processes will be able to access your keys without prompting for your passphrase."
            )
...
def read_passphrase_from_file(passphrase_file: TextIOWrapper) -> str:
    passphrase = passphrase_file.read().rstrip(os.environ.get("LOTTERY_PASSPHRASE_STRIP_TRAILING_CHARS", "\r\n"))
...
def initialize_passphrase() -> None:
    if Keychain.has_master_passphrase():
        ...
        print("\nUse 'lottery passphrase set' or 'lottery passphrase remove' to update or remove your passphrase")
        sys.exit(1)
