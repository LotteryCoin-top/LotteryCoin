...
def show_plots(root_path: Path) -> None:
    ...
    print(
        "Add with 'lottery plots add -d [dir]' and remove with"
        + " 'lottery plots remove -d [dir]'"
        + " Scan and check plots with 'lottery plots check'"
    )
    print()
...
def plots_cmd(ctx: click.Context) -> None:
    ...
    from chia.util.lottery_logging import initialize_logging
