...
from chia.cmds.cmd_classes import NeedsWalletRPC, lottery_command, command_helper, option
...
@lottery_command(signer_cmd, "apply_signatures", "Apply a signer's signatures to a transaction bundle")
...
@lottery_command(signer_cmd, "execute_signing_instructions", "Given some signing instructions, return signing responses")
...
@lottery_command(wallet_cmd, "push_transactions", "Push a transaction bundle to the wallet to send to the network")
...
# @lottery_command(signer_cmd, "temp", "")
# class Temp:
#     qr: QrCodeDisplay
#
#     def run(self) -> None:
