...
@click.option("--testnet", is_flag=True, help="Configure this lottery install to connect to the testnet")
...
def init_cmd(
    ...
    - Make a copy of your Farming Machine CA directory: ~/.lottery/[version]/config/ssl/ca
    - Shut down all lottery daemon processes with `lottery stop all -d`
    - Run `lottery init -c [directory]` on your remote harvester,
      where [directory] is the copy of your Farming Machine CA directory
    - Get more details on remote harvester on Lottery wiki:
      https://github.com/LotteryCoin-top/LotteryCoin/wiki/Farming-on-many-machines
    """
...
if __name__ == "__main__":
    ...
    from .init_funcs import lottery_init

    lottery_init(DEFAULT_ROOT_PATH)
