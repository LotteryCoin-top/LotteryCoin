...
help_text = """
\b
    The purpose of this command is find potential issues in Lottery wallet databases.
    The core lottery client currently uses sqlite to store the wallet databases, one database per key.
\b
