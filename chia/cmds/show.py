...
def show_cmd(
    ...
    if connections:
        print("'lottery show -c' has been renamed to 'lottery peer full_node -c' ")
    if add_connection != "":
        print("'lottery show -a' has been renamed to 'lottery peer full_node -a' ")
    if remove_connection != "":
        print("'lottery show -r' has been renamed to 'lottery peer full_node -r' ")
    if wallet_rpc_port is not None:
        print("'lottery show -wp' is not used, please remove it from your command.")
    asyncio.run(
        show_async(
            rpc_port,
            ctx.obj["root_path"],
