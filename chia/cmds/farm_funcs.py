...
async def summary(
    ...
    if amounts is not None:
        print(f"Total lottery farmed: {amounts['farmed_amount'] / units['lottery']}")
        print(f"User transaction fees: {amounts['fee_amount'] / units['lottery']}")
        print(f"Block rewards: {(amounts['farmer_reward_amount'] + amounts['pool_reward_amount']) / units['lottery']}")
    ...
    if amounts is None:
        if wallet_not_running:
            print("For details on farmed rewards and fees you should run 'lottery start wallet' and 'lottery wallet show'")
        elif wallet_not_ready:
            print("For details on farmed rewards and fees you should run 'lottery wallet show'")
    else:
        print("Note: log into your key using 'lottery wallet show' to see rewards for each key")
