    ...
    if is_transaction_block:
        ...
        if height > 0:
            ...
            pool_coin = create_pool_coin(
                curr_height, curr.pool_puzzle_hash, calculate_pool_reward(curr_height), constants.GENESIS_CHALLENGE
            )
            ...
            if curr_height % ISSUE_HEIGHT_PER_LOTTERY == 0:
                lottery_bonus_coin = create_lottery_bonus_coin(
                    curr.height,
                    FUNDS_PUZZLE_HASH,
                    calculate_lottery_bonus(curr.height),
                    constants.GENESIS_CHALLENGE,
                )
                reward_claims_incorporated.append(lottery_bonus_coin)
            if curr.fees > 0:
                ...
                reward_claims_incorporated.append(fee_coin)
            ...
            if curr.height > 0:
                ...
                while not curr.is_transaction_block:
                    ...
                    reward_claims_incorporated += [pool_coin, farmer_coin]
                    if curr.height % ISSUE_HEIGHT_PER_LOTTERY == 0:
                        lottery_bonus_coin = create_lottery_bonus_coin(
                            curr.height,
                            FUNDS_PUZZLE_HASH,
                            calculate_lottery_bonus(curr.height),
...
def create_unfinished_block(
    ...
    Args:
        ...
        stake_lock_records: Stake lock records
