...
{
    Write-Output "This script requires that the LotteryCoin Python virtual environment is activated."
...
try {
    ...
    Write-Output ""
    Write-Output "LotteryCoin Install-gui.ps1 completed."
    Write-Output ""
    Write-Output "Type 'cd LotteryCoin-gui' and then 'npm run electron' to start the GUI."
} finally {
    Pop-Location
}