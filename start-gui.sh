...
if [ -z "$VIRTUAL_ENV" ]; then
  echo "This requires the lottery python virtual environment."
...
GUI_BUILD_PATH="${SCRIPT_DIR}/LotteryCoin-gui/packages/gui/build/electron/main.js"
