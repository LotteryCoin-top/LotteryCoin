...
{
    Write-Output "This script requires that the Lottery Python virtual environment is activated."
...
function Get-MadmaxUrl()
{
    ...
    $GITHUB_BASE_URL = "https://github.com/Chia-Network/lottery-plotter-madmax/releases/download"
